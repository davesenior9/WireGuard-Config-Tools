...
def user_generate(client_number, description):
    ...
    default_data = [(f'#Client{client_number} = {description}\n'),'[Interface]\n', (f'PrivateKey = {private_key}'), (f'Address = 10.0.0.{client_number}/32\n'), 'DNS = 10.0.0.1\n', '\n', '[Peer]\n','PublicKey = uJRgRh9Cj8TKtgSxkxGmB4ZeXwJE3kOxqkGnOaxSiAs=\n', 'AllowedIPs = 10.0.0.0/24, 192.168.8.0/24\n','Endpoint = vmsvpn.ddns.net:41194\n']
...
def server_side(client_number,description):
    ...
    default_data = ['\n','[Peer]\n', (f'#{description}\n'), (f'AllowedIPs = 10.0.0.{client_number}/32\n'), (f'PublicKey = {public_key}\n')]
